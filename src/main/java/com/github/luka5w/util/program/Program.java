...
import com.github.luka5w.programtemplate.Constants;
...
public class Program {
    ...
    public void init() {
        ...
        if (this.cmd.hasOption("v")) CLIUtils.logAndExit(Constants.PROGRAM_VERSION, 0); /// exit 0
